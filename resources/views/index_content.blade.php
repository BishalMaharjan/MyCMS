  ...
  <table class="table">
    ...
    <tbody>
      <div class="d-flex" style="display:flex; justify-content:flex-end; width:100%; margin-left:-14px;">
        <a href="create"class="btn btn-success ">Add a new content +</a><i class="fas fa-magic ml-1"></i>
        <a href="/categories/index"class="btn btn-primary ">View all categories ></a><i class="fas fa-magic ml-1"></i>
        <br>
      </div>
      <br>
     <br>
